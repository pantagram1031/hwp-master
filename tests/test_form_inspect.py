...
선택적 로컬 픽스처 기반 — HWP_MASTER_PRIVATE_FIXTURES가 없으면 skip.
...
PRIVATE_ROOT = os.environ.get("HWP_MASTER_PRIVATE_FIXTURES", "")
TEMPLATES_DIR = os.path.join(PRIVATE_ROOT, "templates") if PRIVATE_ROOT else "__missing__"
SONON_FORM = os.path.join(TEMPLATES_DIR, "소논문_기본양식.hwpx")
DAESU_FORM = os.path.join(TEMPLATES_DIR, "대수_추가탐구기록지_양식.hwpx")
OUT_HWPX = os.path.join(PRIVATE_ROOT, "layout", "out.hwpx") if PRIVATE_ROOT else "__missing__"
