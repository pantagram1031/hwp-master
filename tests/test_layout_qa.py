...
선택적 로컬 PDF 픽스처 기반 — COM 불필요, 오프라인.
...
FIXDIR = os.environ.get("HWP_MASTER_LAYOUT_FIXTURES", "__missing__")
OUT_PDF = os.path.join(FIXDIR, "out.pdf")
PROBE_PDF = os.path.join(FIXDIR, "probe15.pdf")
