...
선택적 로컬 assembled HWPX 픽스처 기반 — 없으면 skip.
...
FIXTURE = os.environ.get("HWP_MASTER_ASSEMBLED_FIXTURE", "__missing__")
ANCHOR = "Ⅰ. 서 론"

pytestmark = pytest.mark.skipif(
    not os.path.exists(FIXTURE),
    reason="optional assembled HWPX fixture not configured",
)
