...
문단 서식(정렬/줄간격/글자크기) 시각적 보존 검증. 선택적 로컬
baseline/output 픽스처는 환경변수로 제공하며, 없으면 skip.
...
FORM = os.environ.get("HWP_MASTER_FORM_FIXTURE", "__missing__")
OUT = os.environ.get("HWP_MASTER_OUTPUT_FIXTURE", "__missing__")
